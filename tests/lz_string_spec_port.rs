...
fn binary_encoding_compatibility_tests_optional() {
    ...
    // to maintain strict backwards compatibility with https://github.com/pieroxy/lz-string/issues/110
    eprintln!("base64 with four padded = signs");
    let base64_decompressed = "Lorem ipsum dolor sit";
    let base64_compressed = "DIewTgpgtgBAlgBwM4FdYBMQBtwyXAFyA====";
    test_enc_bin_compat(
        lz_str::compress_to_base64,
        &base64_decompressed.encode_utf16().collect::<Vec<u16>>(),
        base64_compressed.to_string(),
    ...
    eprintln!("proper base64 compression no padding");
    let base64_decompressed = "Lorem ipsum dolor sit";
    let base64_compressed = "DIewTgpgtgBAlgBwM4FdYBMQBtwyXAFyA";
    test_enc_bin_compat(
        lz_str::compress_to_base64_proper,
        &base64_decompressed.encode_utf16().collect::<Vec<u16>>(),
        base64_compressed.to_string(),
    );

    eprintln!("proper base64 compression max padding");
    let base64_decompressed = "Lorem ipsum dolor";
    let base64_compressed = "DIewTgpgtgBAlgBwM4FdYBMQBtxA==";
    test_enc_bin_compat(
        lz_str::compress_to_base64_proper,
        &base64_decompressed.encode_utf16().collect::<Vec<u16>>(),
        base64_compressed.to_string(),
